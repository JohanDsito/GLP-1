export const sideEffectsContentEs = {
  ...
  constipation: {
    ...
    whatToDo:
      'Aumenta el consumo de agua durante el dia. Agrega fibra poco a poco (verduras, frutas, granos enteros), ya que agregarla muy rapido puede empeorar la hinchazon. El movimiento ligero regular (caminar) puede ayudar. Si persiste mas de unos dias o causa dolor importante, habla con tu medico.',
    supplements: ['Psyllium u otro suplemento de fibra', 'Magnesio (comentado comunmente con el medico)'],
  },
  diarrhea: {
    title: 'Diarrea',
    cause:
  ...
  hairLoss: {
    title: 'Caida de cabello',
    cause:
      'La perdida rapida de peso y la menor ingesta de calorias/proteina pueden llevar a los foliculos capilares a una fase de reposo (efluvio telogeno), causando una caida notable unos meses despues.',
    whatToDo:
      'Asegurate de comer suficiente proteina a diario — este es el vacio mas comun. Evita una restriccion calorica demasiado agresiva. La caida de cabello por esta causa suele ser temporal y mejora cuando la ingesta se estabiliza. Si la caida es severa o no mejora, consulta a un dermatologo.',
    supplements: ['Multivitaminico', 'Biotina', 'Revision de la ingesta de proteina con un profesional de nutricion'],
  },
  dehydration: {
    title: 'Deshidratacion',
    cause:
  ...
  muscleLoss: {
    title: 'Perdida muscular / flacidez de piel',
    cause:
      'Una parte importante de la perdida rapida de peso puede venir de musculo en vez de grasa si no se prioriza la proteina y el entrenamiento de resistencia, lo que tambien puede hacer que la piel se vea mas flacida.',
    whatToDo:
      'Prioriza proteina en cada comida e incluye entrenamiento de fuerza/resistencia (aunque sea ligero, en casa) en vez de solo cardio. Este es uno de los efectos mas prevenibles con la rutina adecuada — consulta a tu medico o un entrenador sobre un plan adecuado para tu situacion.',
    supplements: ['Suplemento de proteina (whey o vegetal, si la dieta sola no es suficiente)'],
  },
  headache: {
    title: 'Dolor de cabeza',
    cause:
      'Puede relacionarse con deshidratacion, baja ingesta de alimentos/calorias, o la adaptacion del cuerpo al medicamento.',
    whatToDo:
      'Primero revisa tu hidratacion y si has comido suficiente ese dia. Descansa en un espacio tranquilo y oscuro si hace falta. Si los dolores de cabeza son frecuentes, severos, o nuevos para ti, comentalo con tu medico.',
    supplements: [],
  },
  moodSwings: {
  ...
  anxiety: {
    title: 'Ansiedad',
    cause:
      'Puede originarse en el ajuste fisico al medicamento, la preocupacion por los efectos secundarios, o el peso emocional de un cambio grande de estilo de vida.',
    whatToDo:
      'Tecnicas de aterrizaje (respiracion lenta, caminatas cortas) pueden ayudar en el momento. Mantener una rutina constante reduce la incertidumbre. Si la ansiedad es persistente o afecta tu dia a dia, vale la pena hablarlo con tu medico o un profesional de salud mental — esto es comun y tratable.',
    supplements: [],
  },
  lowMotivation: {
    title: 'Baja motivacion / apatia',
    cause:
